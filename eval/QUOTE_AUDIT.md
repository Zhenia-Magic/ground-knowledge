...
|---|---:|---:|---:|---:|---:|
| 177f5ec738c9.kb.json | 36 | 36 | 0 | 0 | 0 |
| 51fb332b4e96.kb.json | 67 | 67 | 0 | 0 | 0 |
| blackholes.kb.json | 15 | 15 | 0 | 0 | 0 |
| covid.kb.json | 26 | 26 | 0 | 0 | 0 |
| eggs.kb.json | 20 | 20 | 0 | 0 | 0 |

Position excerpts: **164 exact of 164**; 0 fuzzy, 0 missing, 0 unchecked.

All stored excerpts (position, dependency, and factor): **381 exact of 381**; 0 fuzzy, 0 missing, 0 unchecked. Every non-exact item is visibly downgraded and excluded from automatic root confirmation.
